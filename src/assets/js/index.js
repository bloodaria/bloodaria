...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
            { "message": "Bienvenue sur Bloodaria, prêt pour la guerre ?", "author": "Bloodaria" },
            { "message": "PvP, Factions, Raids... Que la bataille commence !", "author": "Bloodaria" },
            { "message": "Forge ton empire, domine tes ennemis.", "author": "Bloodaria" },
            { "message": "La victoire appartient aux plus stratégiques.", "author": "Bloodaria" },
            { "message": "Rejoins ta faction et conquiers le monde !", "author": "Bloodaria" }
        ];
